...
namespace Connect_4
{
    public class Board
    {
        ...
        private bool CheckXAxisAi(int row, int column, Coin coinColor)
        {
            if (column + 2 >= Columns) { return false; }
        ...
        private bool CheckYAxisAi(int row, int column, Coin coinColor)
        {
            if (row + 2 >= Rows) { return false; }
        ...
        private bool CheckDiagonallyDownAi(int row, int column, Coin coinColor)
        {
            if (row + 2 >= Rows) { return false; }
            if (column + 2 >= Columns) { return false; }
        ...
        private bool CheckDiagonallyUpAi(int row, int column, Coin coinColor)
        {
